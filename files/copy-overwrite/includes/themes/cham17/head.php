...
<link href="<?=nomad::versionedResourcePath("/res-nomad/$theme/css/all5.css")?>" rel="stylesheet" type="text/css" title="css"/>
...
<? endif ?>
<script type="text/javascript" src="<?="$sitepath/res-nomad/$theme/js/jquery-1.11.3.min.js" ?>"></script>
...
<script> jQuery(document).ready(function($){try{top.setPageLoaded(window,'<?=nomad::pagePath('')?>');}catch(e){ }}); // for frameset based previous site comparison tool </script>
